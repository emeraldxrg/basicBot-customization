...
A branch of basic bot edited for Electrification/
...
Created by [Yemasthui](https://github.com/Yemasthui) but modified by [ZoltofLightning and Choccat].
...
`javascript:(function(){$.getScript('https://rawgit.com/ZoltofLightning/basicBot-customization/master/extension.js');})();`
